...
extension ElFontNumExtension on num {
  ...
  double rem(BuildContext context) => context.globalFontSize * this;
}

extension ElFontContextExtension on BuildContext {
  /// 全局文本尺寸
  double get globalFontSize => ElApp.of(this).textStyle.fontSize!;
}
