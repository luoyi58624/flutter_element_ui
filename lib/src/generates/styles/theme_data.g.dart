...
extension ElThemeDataExtension on ElThemeData {
  ElThemeData copyWith({
    ...
    Color? error,
    ElColorData? colors,
    ElButtonThemeData? buttonStyle,
    ElLinkThemeData? linkStyle,
    ElInputThemeData? inputStyle,
    ElCollapseThemeData? collapseStyle,
    ElCardThemeData? cardStyle,
    ElModalThemeData? modalStyle,
    ElMessageThemeData? messageStyle,
    ElToastThemeData? toastStyle,
    ElTooltipThemeData? tooltipStyle,
    ElSliderThemeData? sliderStyle,
    ElHeaderStyle? headerStyle,
    ElAsideStyle? asideStyle,
    ElNavMenuThemeData? navigationMenuStyle,
