...
class ElDevice {
  ...
  /// 当前设备是否是小米
  static bool get isXiaomi => androidInfo?.manufacturer.toLowerCase() == 'xiaomi';
  ...
  /// 当前设备是否是一加
  static bool get isOnePlus => androidInfo?.manufacturer.toLowerCase() == 'oneplus';

  /// 当前设备是否是红米
  static bool get isRealme => androidInfo?.manufacturer.toLowerCase() == 'realme';

  /// 当前设备是否是Vivo
  static bool get isVivo => androidInfo?.manufacturer.toLowerCase() == 'vivo';

  /// 当前设备是否是华为
  static bool get isHUAWEI => androidInfo?.manufacturer.toLowerCase() == 'huawei';
  ...
  /// 当前设备是否是三星
  static bool get isSamsung => androidInfo?.manufacturer.toLowerCase() == 'samsung';

  /// 当前设备是否是乐视
  static bool get isLetv => androidInfo?.manufacturer.toLowerCase() == 'letv';

  /// 当前设备是否是酷派
  static bool get isYulong => androidInfo?.manufacturer.toLowerCase() == 'yulong';

  /// 当前设备是否是联想
  static bool get isLENOVO => androidInfo?.manufacturer.toLowerCase() == 'lenovo';
