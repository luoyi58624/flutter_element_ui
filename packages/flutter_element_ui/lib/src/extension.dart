...
// ===============================================================
// 1. 扩展函数虽然可以让你更方便地使用Api, 但是很容易与其他扩展函数引起冲突。
// 2. Element UI 公开的扩展函数均以 El 命名开头，以 Extension 作为结尾。
// 3. 使用过程中如果发现冲突，你可以使用 hide 关键字隐藏冲突的扩展函数。
// 4. Element UI所有扩展函数都定义在此文件中，这里的源码都很简单。
// ===============================================================
...
extension ColorExtension on Color {
  ...
  Color elLight1(
    ...
    bool reverse = false,
      ...
      !reverse ? (context.isDark ? darken(8) : brighten(10)) : (context.isDark ? brighten(10) : darken(8));
  ...
  Color elLight2(
    ...
    bool reverse = false,
      ...
      !reverse ? (context.isDark ? darken(16) : brighten(20)) : (context.isDark ? brighten(20) : darken(16));
  ...
  Color elLight3(
    ...
    bool reverse = false,
      ...
      !reverse ? (context.isDark ? darken(24) : brighten(30)) : (context.isDark ? brighten(30) : darken(24));
  ...
  Color elLight4(
    ...
    bool reverse = false,
      ...
      !reverse ? (context.isDark ? darken(32) : brighten(40)) : (context.isDark ? brighten(40) : darken(32));
  ...
  Color elLight5(
    ...
    bool reverse = false,
      ...
      !reverse ? (context.isDark ? darken(40) : brighten(50)) : (context.isDark ? brighten(50) : darken(40));
  ...
  Color elLight6(
    ...
    bool reverse = false,
      ...
      !reverse ? (context.isDark ? darken(48) : brighten(60)) : (context.isDark ? brighten(60) : darken(48));
  ...
  Color elLight7(
    ...
    bool reverse = false,
      ...
      !reverse ? (context.isDark ? darken(56) : brighten(70)) : (context.isDark ? brighten(70) : darken(56));
  ...
  Color elLight8(
    ...
    bool reverse = false,
      ...
      !reverse ? (context.isDark ? darken(64) : brighten(80)) : (context.isDark ? brighten(80) : darken(64));
  ...
  Color elLight9(
    ...
    bool reverse = false,
      ...
      !reverse ? (context.isDark ? darken(72) : brighten(90)) : (context.isDark ? brighten(90) : darken(72));
