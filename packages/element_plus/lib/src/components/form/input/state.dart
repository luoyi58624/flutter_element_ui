...
class ElInputState extends ElModelValueState<ElInput, String> {
  ...
  Widget buildTextField(BuildContext context) {
    return TextFormField(
      ...
      style: TextStyle(
        fontSize: 14,
        color: context.elTheme.textTheme.textStyle.color,
  ...
  InputDecoration _buildInputDecoration(BuildContext context) {
    return InputDecoration(
      ...
      enabledBorder: OutlineInputBorder(
        ...
        borderSide: BorderSide(
          color: context.isHover
              ? context.elTheme.layoutTheme.borderColor!.deepen(16)
      ...
      hintStyle: ElDefaultTextStyle.of(context).style.copyWith(
            fontSize: 14,
            color: context.elTheme.textTheme.placeholderStyle.color,
          ),
