...
class ElThemeData extends _ElThemeData {
  ...
  /// 边框按钮默认样式
  final ElOutlineButtonThemeData outlineButtonTheme;

  /// 文字按钮默认样式
  final ElTextButtonThemeData textButtonTheme;
  ...
  ElThemeData copyWith({
    ...
    return ElThemeData._(
      ...
      navbarColor: navbarColor ?? super.navbarColor,
      sidebarColor: sidebarColor ?? super.sidebarColor,
      footerColor: footerColor ?? super.footerColor,
...
extension ElResponsiveDataExtension on ElResponsiveData {
  ...
  /// 接收一个对象，将它内部属性和原来对象进行 copy，然后返回新的对象
  ElResponsiveData merge([ElResponsiveData? other]) {
    if (other == null) return this;
    return copyWith(
      xs: other.xs,
      sm: other.sm,
  ...
  /// 生成 hashCode 方法
  int get _hashCode =>
      xs.hashCode ^ sm.hashCode ^ md.hashCode ^ lg.hashCode ^ xl.hashCode;
}
